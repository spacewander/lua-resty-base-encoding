                       ...
                       uint32_t out_in_lowercase)
{
    ...
    const uint8_t *gsHexEncodeC1;
    const uint8_t *gsHexEncodeC2;
    if (out_in_lowercase == 1) {
        gsHexEncodeC1 = gsHexEncodeC1Lower;
        gsHexEncodeC2 = gsHexEncodeC2Lower;

    } else {
        gsHexEncodeC1 = gsHexEncodeC1Upper;
        gsHexEncodeC2 = gsHexEncodeC2Upper;
    }
